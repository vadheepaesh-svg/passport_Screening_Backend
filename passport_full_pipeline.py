...
ELA_JPEG_QUALITY = 90
ELA_SCALE_FACTOR = 15
ELA_SUSPICION_THRESHOLD = 60

COPY_MOVE_MIN_DISTANCE_PX = 60
COPY_MOVE_MIN_MATCHES = 500
...
WEIGHT_MRZ_LOGIC = 0.5  # Module 1/2's checksum + logic risk
WEIGHT_TAMPERING = 0.55   # Module 3's digital tampering score (ELA/copy-move/metadata)
WEIGHT_PHYSICAL = 0.5# Module 3's physical consistency score (photo-swap check)
# ============================================================
